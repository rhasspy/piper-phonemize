...
typedef map<Phoneme, vector<PhonemeId>> PhonemeIdMap;
...
struct PhonemeIdConfig {
  ...
  shared_ptr<PhonemeIdMap> phonemeIdMap;
};
...
PhonemeIdMap DEFAULT_PHONEME_ID_MAP = {
    ...
    {U'θ', {126}},      {U'χ', {127}},      {U'ᵻ', {128}},
    {U'ⱱ', {129}},      {U'0', {130}},      {U'1', {131}},
...
// language -> phoneme -> [id, ...]
map<string, PhonemeIdMap> DEFAULT_ALPHABET = {
    // Ukrainian
    {"uk",
     {
         {U'_', {0}},  {U'^', {1}},       {U'$', {2}},       {U' ', {3}},
...
void phonemes_to_ids(const vector<Phoneme> &phonemes, PhonemeIdConfig &config,
                     vector<PhonemeId> &phonemeIds) {

  auto phonemeIdMap = make_shared<PhonemeIdMap>(DEFAULT_PHONEME_ID_MAP);
